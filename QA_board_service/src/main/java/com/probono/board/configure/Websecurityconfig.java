package com.probono.board.configure;
import com.probono.board.JwtAuthenticationFilter;
import com.probono.board.JwtTokenProvider;
        ...
        return http
                ...
                .authorizeHttpRequests(requests ->
                        requests.requestMatchers("/", "/swagger-ui/**", "/v3/**","/error").permitAll()// requestMatchers의 인자로 전달된 url은 모두에게 허용
                                .requestMatchers("/qa-board/**").hasRole("USER")
